...
const AccountPage = () => {
    ...
    return (
        <div className='min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.16),_transparent_48%),linear-gradient(135deg,_#f8fbff_0%,_#f5f7fb_100%)] px-3 py-4 sm:px-6 sm:py-6 lg:px-8'>
            <div className='mx-auto flex max-w-7xl flex-col gap-4 sm:gap-6'>
                <section className='overflow-hidden rounded-[24px] border border-slate-200/80 bg-white/85 p-4 shadow-[0_30px_80px_-30px_rgba(2,6,23,0.35)] backdrop-blur-xl sm:rounded-[30px] sm:p-8'>
                ...
                <section className='grid gap-4 lg:grid-cols-[1.2fr_0.8fr]'>
                    <div className='rounded-[20px] border border-slate-200/80 bg-white/90 p-4 shadow-[0_20px_60px_-30px_rgba(2,6,23,0.3)] sm:rounded-[24px] sm:p-6'>
                    ...
                    <div className='rounded-[20px] border border-slate-200/80 bg-slate-950 p-4 text-white shadow-[0_20px_60px_-30px_rgba(2,6,23,0.45)] sm:rounded-[24px] sm:p-6'>
